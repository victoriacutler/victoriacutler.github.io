...
legend_title_hi = expression("Fig 2. Solar Saturation (%) in Higher Income Census Tracts")
higherincome_map <- tm_shape(higherincome) +
  tm_fill(col = "pct_qual_with_solar",
          title = legend_title_hi,
          breaks = c(0, 5, 10, 15, 20, 25, Inf),
          style = "pretty",
          palette = "Blues",
          size = 3)

legend_title_li = expression("Fig 3. Solar Saturation (%) in Lower Income Census Tracts")
lowerincome_map <- tm_shape(lowerincome) +
  tm_fill(col = "pct_qual_with_solar",
          title = legend_title_li,
          breaks = c(0, 5, 10, 15, 20, 25, Inf),
          style = "pretty",
          palette = "Blues")
...
1.  Missing census tracts for solar
